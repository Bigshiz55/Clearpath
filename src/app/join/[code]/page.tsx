      ...
      <main className="container-page mx-auto max-w-md py-8">
        {crewName ? (
          ...
          <div className="card p-8 text-center">
            ...
            <p className="mt-2 text-sm text-slate-400">Ask for a fresh link, or explore WatchVerdict yourself.</p>
            <Link href="/app" className="btn-secondary mt-5 inline-flex">Open WatchVerdict →</Link>
          </div>
        )}
      </main>
    </div>
