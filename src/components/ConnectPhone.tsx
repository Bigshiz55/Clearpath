...
export function ConnectPhone() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="card p-4">
        <div className="text-sm font-semibold text-white">🗣️ iPhone: “Hey Siri, add to WatchVerd1ct”</div>
        <ol className="mt-2 list-decimal space-y-1.5 pl-5 text-sm text-slate-300">
          ...
          <li>Name it <span className="text-white">“Add to WatchVerd1ct.”</span> Done — say <span className="text-white">“Hey Siri, Add to WatchVerd1ct.”</span></li>
        </ol>
      </div>
      ...
      <div className="card p-4">
        ...
        <ol className="mt-2 list-decimal space-y-1.5 pl-5 text-sm text-slate-300">
          ...
          <li>Name it <span className="text-white">“Add to WatchVerd1ct.”</span> Now: screenshot a title → <span className="text-white">Share → Add to WatchVerd1ct.</span></li>
        </ol>
      ...
      <p className="text-xs text-slate-500">
        ...
        just use the system <span className="text-slate-300">Share → WatchVerd1ct</span>.
      </p>
    </div>
  );
}
