  ...
  return (
    <div className="min-h-dvh">
      <header className="container-page flex h-16 items-center">
        <span className="text-lg font-bold tracking-tight text-white">Watch<span className="text-brand-300">Vrd<span className="text-[#ff1493]">IQ</span>t</span> · ⚖️ Court</span>
      </header>
