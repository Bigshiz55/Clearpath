  ...
  return (
    <div className="min-h-dvh">
      <header className="container-page flex h-16 items-center">
        <span className="text-lg font-bold tracking-tight text-white">Watch<span className="text-[#ff1493]">VERD<span className="text-white">1</span>CT</span> · ⚖️ Court</span>
      </header>
