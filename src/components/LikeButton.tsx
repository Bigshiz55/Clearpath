  ...
  return (
    <>
      <button
        ...
        className="flex min-h-[44px] w-full min-w-0 flex-1 items-center justify-center gap-0.5 rounded-lg border border-white/10 bg-white/[0.06] text-slate-300 transition hover:border-emerald-400/50 hover:bg-emerald-500/15 hover:text-emerald-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400/60 disabled:opacity-60"
      >
