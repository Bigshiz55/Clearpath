  ...
  return (
    <>
      <button
        ...
        className="flex min-h-[44px] w-full min-w-0 flex-1 items-center justify-center gap-1 rounded-lg border-2 border-emerald-400/70 bg-emerald-500/25 text-emerald-100 transition hover:bg-emerald-500/40 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400/60 disabled:opacity-60"
      >
        ...
        <span className="whitespace-nowrap text-[11px] font-black uppercase tracking-wide">For</span>
      </button>
