...
export function AlgorithmScore({
  ...
  return (
    <div
      ...
      title="WatchVrdikt algorithm — your DNA blended with every rating into one 0–100 estimate of how much YOU will like it."
    >
      {/* The WatchVrdikt mark + the ruling itself (Stream It / …) — one line. */}
