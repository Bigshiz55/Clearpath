  ...
  return (
    <div className="mt-5">
      ...
      <div className="flex flex-col items-center text-center">
        <div className="h-72 w-48 overflow-hidden rounded-2xl border border-white/10 shadow-card">
      ...
      <div className="mt-5">
        ...
        <button
          onClick={skip}
          className="mt-3 w-full rounded-xl border border-white/10 bg-white/5 py-2.5 text-sm font-medium text-slate-300 hover:bg-white/10"
        >
