  ...
  return (
    <>
      <button
        ...
        className={
          compact
            ? `flex min-h-[44px] min-w-0 items-center justify-center gap-1 rounded-lg border-2 border-red-400/70 bg-red-500/25 text-red-100 transition hover:bg-red-500/40 hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400/60 disabled:opacity-60 ${wide ? 'w-full flex-1' : 'w-11'}`
      ...
      >
        {/* The icon is decorative and it cost the label a whole second line at
            320–440px. Colour is the signal now; the words are the meaning. It
            stays in the icon-only variant, where it is the only content. */}
        {(!compact || !wide) && (
