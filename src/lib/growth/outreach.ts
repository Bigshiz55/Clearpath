  ...
  switch (channel) {
    case 'email':
      return {
        ...
        body:
          `Hi ${name},\n\nI'm a solo founder building WatchVerdict — it learns why people say no to a title (too slow, too dark, not tonight) and gives one clear verdict for their mood, plus a group verdict when people can't agree.\n\nGiven${aud(i)}, I thought it might genuinely be useful to share. Would you be open to a quick look? Happy to give your followers founding-member early access.\n\n2-min try: ${link}\n\nThank you,\n[Your name]`,
      };
    case 'instagram_dm':
    case 'tiktok_dm':
      return {
        body:
          `Hey ${name}! Love what you post. I built WatchVerdict — it learns your taste and calls one verdict for tonight (and settles group “what do we watch” fights). Thought it might be fun for${aud(i)}. Open to a quick look / collab? Founding-member access for your people: ${link}`,
      };
    case 'reddit':
      return {
        subject: 'I built a taste-matcher that learns WHY you say no to a movie',
        body:
          `Not trying to spam — genuinely want feedback from people who watch a lot. WatchVerdict learns why you pass (too slow, too dark, not in the mood) and gives one verdict for your mood, plus a group verdict when you can't agree with someone. It's free and early. What would make it actually useful to you? ${link}`,
      };
    case 'facebook_group':
      return {
        body:
    ...
    case 'discord':
      return {
        body:
          `hey ${name} 👋 built a thing for the eternal “what do we watch” problem — WatchVerdict learns your taste and gives one verdict, plus group rooms so a server can pick together. free + early, feedback very welcome: ${link}`,
      };
    case 'creator_pitch':
      return {
        subject: 'Collab idea: “rate my watchlist” with WatchVerdict',
        body:
          `Hi ${name},\n\nI'm the founder of WatchVerdict (learns taste → one honest verdict; group rooms for “we can't agree”). A simple, high-performing format for${aud(i)}: “I let an app rate my entire watchlist.” It's visual, a little spicy, and easy.\n\nHappy to set up founding-member access + a tracked link so you get credit for signups. Would you be up for a quick chat?\n\n${link}\n\n[Your name]`,
      };
    case 'beta_invite':
      return {
        subject: 'Founding-member early access to WatchVerdict',
        body:
          `Hi ${name},\n\nYou're on the short list for founding-member access to WatchVerdict. Build your Watch DNA in ~60 seconds and get one honest verdict for tonight — then invite a partner/friend for a group verdict.\n\nStart here: ${link}\n\nI read every piece of feedback personally.\n[Your name]`,
      };
    case 'follow_up':
      return {
        body:
