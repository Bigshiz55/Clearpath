...
// Comparison-cue reference extraction is a PURE helper reused by the retrieval
// pipeline; it lives in askJudge.shared (no server-only) and is re-exported here.
export { extractReference } from '@/lib/askJudge.shared';
